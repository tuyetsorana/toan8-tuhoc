...
> - **Nhân đa thức với đa thức:** Lấy mỗi hạng tử của đa thức này nhân lần lượt với từng hạng tử của đa thức kia rồi cộng các kết quả lại.

---

#### 📐 Công Thức Trọng Tâm:

> **Đơn thức $\times$ Đa thức:**
>
> $$A(B + C) = A \cdot B + A \cdot C$$
>
> ---
>
> **Đa thức $\times$ Đa thức:**
>
...
>
> $$x^m \cdot x^n = x^{m+n} \quad \text{(CỘNG số mũ, không nhân số mũ)}$$

---

#### ⚠️ Sai Lầm Thường Gặp Cần Tránh:

> - ❌ **Lỗi 1:** Nhân số mũ: $x^2 \cdot x^3 = x^6$ (SAI) ➔ Đúng là $x^{2+3} = x^5$.
> - ❌ **Lỗi 2:** Bỏ sót hạng tử: $(A+B)(C+D)$ phải sinh ra đủ 4 tích trước khi thu gọn.
> - ❌ **Lỗi 3:** Sai dấu khi nhân hệ số âm: $(-a) \cdot (-b) = +ab$; $(-a) \cdot b = -ab$.
...
**🔍 Phương pháp tư duy:**
Khai triển tích $(2x - y)(x + 3y)$ ra 4 hạng tử rồi trừ $2x^2$ và thu gọn.

**📝 Lời giải chi tiết:**
- **Bước 1 (Nhân đa thức với đa thức):**
  $$(2x - y)(x + 3y) = 2x \cdot x + 2x \cdot 3y - y \cdot x - y \cdot 3y = 2x^2 + 6xy - xy - 3y^2$$
- **Bước 2 (Thu gọn tích vừa nhân):**
  $$2x^2 + 5xy - 3y^2$$
- **Bước 3 (Trừ $2x^2$ của đề bài):**
  $$Q = (2x^2 + 5xy - 3y^2) - 2x^2 = (2x^2 - 2x^2) + 5xy - 3y^2 = 5xy - 3y^2$$
- **Kết luận:** Biểu thức thu gọn là $5xy - 3y^2$.
